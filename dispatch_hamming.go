...
// dispatch_hamming.go registers HammingScore into the dispatch table
// at package load time. This file MUST be the sole writer to
// dispatch[AlgoHamming].
//
...
// _ ensures dispatch[AlgoHamming] is populated before any call to the
