...
// dispatch_jaro.go registers JaroScore into the dispatch table at package
// load time. This file MUST be the sole writer to dispatch[AlgoJaro].
//
...
// and docs/requirements.md §5(12)); Wave 2 plans copy it character-for-
// character, changing only the AlgoXxx and XxxScore identifiers.

package fuzzymatch

// _ ensures dispatch[AlgoJaro] is populated before any call to the
