...
// dispatch_damerau_full.go registers DamerauLevenshteinFullScore into the
// dispatch table at package load time. This file MUST be the sole writer to
// dispatch[AlgoDamerauLevenshteinFull].
//
...
// _ ensures dispatch[AlgoDamerauLevenshteinFull] is populated before any call
