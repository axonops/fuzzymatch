...
// rationale. The var _ = func() bool { ... }() idiom is the Phase-2-canonical
// form for package-level side effects without init() (per
// determinism-standards §13.5 and docs/requirements.md §5(12)).

package fuzzymatch

// _ ensures dispatch[AlgoTokenJaccard] is populated before any call to
// the Scorer (Phase 8) or Extract (Phase 10) that reads the dispatch
// table. The var _ = func()bool{...}() idiom is the canonical way to
// run package-level side effects without init() (per
