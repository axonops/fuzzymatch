...
// dispatch_jarowinkler.go registers JaroWinklerScore into the dispatch table
// at package load time. This file MUST be the sole writer to
// dispatch[AlgoJaroWinkler].
//
...
// _ ensures dispatch[AlgoJaroWinkler] is populated before any call to the
